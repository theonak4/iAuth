...
<div class="viewing">
  ...
  foreach($current as $value) {
    ...
    echo "
    <img data-toggle='tooltip' data-placement='left' title='{$value}' style='width: 55px; height: 55px; float: left; margin-top: 5px; margin-right: 15px;' src='{$img}' alt='Viewer {$vmt}' class='img-circle'></img>
    ";
  }
...
<div onclick="redirect('/e890/newbls/adminpanel/new/index.php')" class="sidebar-icon sidebar-icon-active" data-toggle="tooltip" data-placement="right" title="Home"><span class="glyphicon glyphicon-home" style="font-size: 30px;" aria-hidden="true"></span></div>
...
<button type='button' class='btn btn-danger' style='margin-left: 83px; margin-top: -44px;'>Sign Out</button>

  "><img data-toggle="popover" style="width: 60px; height: 60px; margin-top: 20px;" src="<?php echo $usrimg; ?>" alt="Profile Picture" class="img-circle"></img></a></center>

</div>

<h1 style="position: fixed; top: 10px; left: 150px;"><?php echo $name ?> <span style="font-size: 25px;"><i>Settings</i></span></h1>

<div class="setting" style="margin-top: 100px; margin-left: 150px; padding-top: 21px;">
  <label class="switch" style="float: right;">
<input id="setting_datacollection" type="checkbox">
<div class="slider"></div>
</label>
    <strong style="margin-top: 20px;">Allow Data Collection</strong> <!-- IF OFF REQUIRE RESTART -->
    <h6 style="margin-top: 0;">Allow iAuth to collect data to better <br>enhance your experience.</h6>


</div>
<div class="setting" style="margin-top: 20px; margin-left: 150px;">
</div>
<div class="setting" style="margin-top: 20px; margin-left: 150px;">
</div>
<div class="setting" style="margin-top: 20px; margin-left: 150px;">
...
<ol class="breadcrumb" style="position: fixed; bottom: -5px; left: 115px; min-width: width: 260px; background: rgb(40,41,54);">
  <li><a href="/e890/newbls/adminpanel/new/
    " style="">Control Panel</a></li>

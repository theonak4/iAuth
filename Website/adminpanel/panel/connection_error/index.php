...
<div style="position: fixed; right: 350; top: 300px;">
  <h1 style="color: #ff4d4d; font-size: 300px; font-weight: bold; margin-top: 0px; margin-bottom: 0px;">!</h1>
</div>


<div style="font-size: 30px; margin-top: 230px; float: left; margin-left: 150px;"> <!-- 370 margin-top -->
...
<span style="font-family: monospace">connection error</span>
<br>
<br>
It seems that out systems have run into a problem. <br>
We are working on a speedy fix. Thank you for<br>
your patience.
<br>
<span style="font-size:20px;">Error Code 3306</span>
<br>
<br>
<br>
<br>
<span style="font-size:20px;">This page will redirect to a login once the system is back up.</span>

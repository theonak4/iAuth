...
function check() {
 ...
 setTimeout(function() {  document.getElementById("loader").style.display="none";  document.getElementById("check").style.display="block";}, 3000)
}
</script>
<center style="margin-top: 220px; letter-spacing: 1px;"><h1 style="font-size: 45px; font-weight: lighter; font-family: montserrat;">MHub Sync</h1></center>
<center><h1 style=" margin: 0;font-size: 68px;font-family: lobster;  font-size: 72px;background: linear-gradient(to right, #4286f4, #4286f4, #e242f4, #e242f4); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><span style="font-family: 'Russo One'">Step 1</span></center>
<center style=""><h3 style="  margin-top: 100px;">Please enter your MHub's UNIQID</h3><input class="ssid" placeholder="XXXX-XXXXX-XXXX" maxlength="15" spellcheck="false"></input></center>
<center><button id="sync" class="begin" onclick="check()">Sync MHub</button><div id="loader" style="display: none;" class="loader"></div><div id="check" style="display: none;" class="checkmark"></div></center>
<br>
<br>
<br>
<center><h4 style="font-style: italic">The UNIQID is located on the bottom of your MHub unit.</h4></center>
